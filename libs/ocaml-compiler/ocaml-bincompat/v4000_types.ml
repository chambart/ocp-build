...
open Lexing
type t = Location.t = { loc_start: position; loc_end: position; loc_ghost: bool }
...
and core_field_type = Parsetree.core_field_type =
  { pfield_desc: core_field_desc;
    pfield_loc: Location.t }

and core_field_desc = Parsetree.core_field_desc =
...
and modtype_declaration = Parsetree.modtype_declaration =
    Pmodtype_abstract
...
type exception_declaration = Types.exception_declaration =
...
type cmi_infos = Cmi_format.cmi_infos = {
    cmi_name : string;
